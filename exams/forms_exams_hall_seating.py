"""
Enterprise Forms for Exams: Exam Seating Matrix
PR #49: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from exams.models_exams_hall_seating import ExamsHallSeatingMaster, ExamsHallSeatingConfiguration, ExamsHallSeatingLedger

class ExamsHallSeatingMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamsHallSeatingMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. EXAMS_HALL_SEATING-001"}),
...
class ExamsHallSeatingConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = ExamsHallSeatingConfiguration
...
class ExamsHallSeatingLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = ExamsHallSeatingLedger
...
class ExamsHallSeatingBatchActionForm(forms.Form):
...
class ExamsHallSeatingSearchFilterForm(forms.Form):
