"""
Enterprise Forms for Exams: Exam Scheduling
PR #48: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from exams.models_exams_schedules import ExamsSchedulesMaster, ExamsSchedulesConfiguration, ExamsSchedulesLedger

class ExamsSchedulesMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamsSchedulesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. EXAMS_SCHEDULES-001"}),
...
class ExamsSchedulesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = ExamsSchedulesConfiguration
...
class ExamsSchedulesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = ExamsSchedulesLedger
...
class ExamsSchedulesBatchActionForm(forms.Form):
...
class ExamsSchedulesSearchFilterForm(forms.Form):
