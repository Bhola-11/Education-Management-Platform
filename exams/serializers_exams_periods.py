"""
Data Transfer Objects & Serializers for Exams: Exam Cycles & Series
PR #47: Structured Data Mapping and Validation DTOs.
"""

from decimal import Decimal
from typing import Dict, Any, List
from exams.models_exams_periods import ExamsPeriodsMaster, ExamsPeriodsConfiguration

class ExamsPeriodsMasterDTO:
    """Data Transfer Object representing a validated ExamsPeriodsMaster instance."""
    def __init__(self, record: ExamsPeriodsMaster):
