"""
Enterprise Forms for Exams: Admit Cards & Hall Tickets
PR #51: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from exams.models_exams_admit_cards import ExamsAdmitCardsMaster, ExamsAdmitCardsConfiguration, ExamsAdmitCardsLedger

class ExamsAdmitCardsMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamsAdmitCardsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. EXAMS_ADMIT_CARDS-001"}),
...
class ExamsAdmitCardsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = ExamsAdmitCardsConfiguration
...
class ExamsAdmitCardsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = ExamsAdmitCardsLedger
...
class ExamsAdmitCardsBatchActionForm(forms.Form):
...
class ExamsAdmitCardsSearchFilterForm(forms.Form):
