"""
Enterprise Forms for Exams: Exam Cycles & Series
PR #47: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from exams.models_exams_periods import ExamsPeriodsMaster, ExamsPeriodsConfiguration, ExamsPeriodsLedger

class ExamsPeriodsMasterForm(forms.ModelForm):
    """Primary form for creating and updating ExamsPeriodsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. EXAMS_PERIODS-001"}),
...
class ExamsPeriodsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = ExamsPeriodsConfiguration
...
class ExamsPeriodsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = ExamsPeriodsLedger
...
class ExamsPeriodsBatchActionForm(forms.Form):
...
class ExamsPeriodsSearchFilterForm(forms.Form):
