"""
Enterprise Forms for Notifications: Email Delivery Queue
PR #77: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from notifications.models_notifications_email import NotificationsEmailMaster, NotificationsEmailConfiguration, NotificationsEmailLedger

class NotificationsEmailMasterForm(forms.ModelForm):
    """Primary form for creating and updating NotificationsEmailMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. NOTIFICATIONS_EMAIL-001"}),
...
class NotificationsEmailConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = NotificationsEmailConfiguration
...
class NotificationsEmailLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = NotificationsEmailLedger
...
class NotificationsEmailBatchActionForm(forms.Form):
...
class NotificationsEmailSearchFilterForm(forms.Form):
