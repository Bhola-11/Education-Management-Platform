"""
Enterprise Forms for Notifications: Campus Broadcasts
PR #78: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from notifications.models_notifications_broadcast import NotificationsBroadcastMaster, NotificationsBroadcastConfiguration, NotificationsBroadcastLedger

class NotificationsBroadcastMasterForm(forms.ModelForm):
    """Primary form for creating and updating NotificationsBroadcastMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. NOTIFICATIONS_BROADCAST-001"}),
...
class NotificationsBroadcastConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = NotificationsBroadcastConfiguration
...
class NotificationsBroadcastLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = NotificationsBroadcastLedger
...
class NotificationsBroadcastBatchActionForm(forms.Form):
...
class NotificationsBroadcastSearchFilterForm(forms.Form):
