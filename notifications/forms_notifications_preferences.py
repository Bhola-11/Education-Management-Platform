"""
Enterprise Forms for Notifications: Notification Preferences
PR #79: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from notifications.models_notifications_preferences import NotificationsPreferencesMaster, NotificationsPreferencesConfiguration, NotificationsPreferencesLedger

class NotificationsPreferencesMasterForm(forms.ModelForm):
    """Primary form for creating and updating NotificationsPreferencesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. NOTIFICATIONS_PREFERENCES-001"}),
...
class NotificationsPreferencesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = NotificationsPreferencesConfiguration
...
class NotificationsPreferencesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = NotificationsPreferencesLedger
...
class NotificationsPreferencesBatchActionForm(forms.Form):
...
class NotificationsPreferencesSearchFilterForm(forms.Form):
