"""
Enterprise Forms for Notifications: Notification Center
PR #76: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from notifications.models_notifications_center import NotificationsCenterMaster, NotificationsCenterConfiguration, NotificationsCenterLedger

class NotificationsCenterMasterForm(forms.ModelForm):
    """Primary form for creating and updating NotificationsCenterMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. NOTIFICATIONS_CENTER-001"}),
...
class NotificationsCenterConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = NotificationsCenterConfiguration
...
class NotificationsCenterLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = NotificationsCenterLedger
...
class NotificationsCenterBatchActionForm(forms.Form):
...
class NotificationsCenterSearchFilterForm(forms.Form):
