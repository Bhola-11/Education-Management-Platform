"""
Enterprise Forms for Accounts: Authentication
PR #3: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from accounts.models_accounts_custom_user import AccountsCustomUserMaster, AccountsCustomUserConfiguration, AccountsCustomUserLedger

class AccountsCustomUserMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountsCustomUserMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACCOUNTS_CUSTOM_USER-001"}),
...
class AccountsCustomUserConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AccountsCustomUserConfiguration
...
class AccountsCustomUserLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AccountsCustomUserLedger
...
class AccountsCustomUserBatchActionForm(forms.Form):
...
class AccountsCustomUserSearchFilterForm(forms.Form):
