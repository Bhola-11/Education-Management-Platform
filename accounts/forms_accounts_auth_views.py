"""
Enterprise Forms for Accounts: Authentication Views
PR #6: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from accounts.models_accounts_auth_views import AccountsAuthViewsMaster, AccountsAuthViewsConfiguration, AccountsAuthViewsLedger

class AccountsAuthViewsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountsAuthViewsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACCOUNTS_AUTH_VIEWS-001"}),
...
class AccountsAuthViewsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AccountsAuthViewsConfiguration
...
class AccountsAuthViewsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AccountsAuthViewsLedger
...
class AccountsAuthViewsBatchActionForm(forms.Form):
...
class AccountsAuthViewsSearchFilterForm(forms.Form):
