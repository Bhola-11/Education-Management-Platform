"""
Enterprise Forms for Accounts: Accounts & Academics Tests
PR #95: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from accounts.models_accounts_and_academics_suite import AccountsAndAcademicsSuiteMaster, AccountsAndAcademicsSuiteConfiguration, AccountsAndAcademicsSuiteLedger

class AccountsAndAcademicsSuiteMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountsAndAcademicsSuiteMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACCOUNTS_AND_ACADEMICS_SUITE-001"}),
...
class AccountsAndAcademicsSuiteConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AccountsAndAcademicsSuiteConfiguration
...
class AccountsAndAcademicsSuiteLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AccountsAndAcademicsSuiteLedger
...
class AccountsAndAcademicsSuiteBatchActionForm(forms.Form):
...
class AccountsAndAcademicsSuiteSearchFilterForm(forms.Form):
