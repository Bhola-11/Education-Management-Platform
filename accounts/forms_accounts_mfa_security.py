"""
Enterprise Forms for Accounts: MFA & Security
PR #7: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from accounts.models_accounts_mfa_security import AccountsMfaSecurityMaster, AccountsMfaSecurityConfiguration, AccountsMfaSecurityLedger

class AccountsMfaSecurityMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountsMfaSecurityMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACCOUNTS_MFA_SECURITY-001"}),
...
class AccountsMfaSecurityConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AccountsMfaSecurityConfiguration
...
class AccountsMfaSecurityLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AccountsMfaSecurityLedger
...
class AccountsMfaSecurityBatchActionForm(forms.Form):
...
class AccountsMfaSecuritySearchFilterForm(forms.Form):
