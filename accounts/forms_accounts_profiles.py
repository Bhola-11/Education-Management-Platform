"""
Enterprise Forms for Accounts: User Profiles
PR #5: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from accounts.models_accounts_profiles import AccountsProfilesMaster, AccountsProfilesConfiguration, AccountsProfilesLedger

class AccountsProfilesMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountsProfilesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACCOUNTS_PROFILES-001"}),
...
class AccountsProfilesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AccountsProfilesConfiguration
...
class AccountsProfilesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AccountsProfilesLedger
...
class AccountsProfilesBatchActionForm(forms.Form):
...
class AccountsProfilesSearchFilterForm(forms.Form):
