"""
Enterprise Forms for Accounts: Role-Based Access Control
PR #4: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from accounts.models_accounts_roles_rbac import AccountsRolesRbacMaster, AccountsRolesRbacConfiguration, AccountsRolesRbacLedger

class AccountsRolesRbacMasterForm(forms.ModelForm):
    """Primary form for creating and updating AccountsRolesRbacMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACCOUNTS_ROLES_RBAC-001"}),
...
class AccountsRolesRbacConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AccountsRolesRbacConfiguration
...
class AccountsRolesRbacLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AccountsRolesRbacLedger
...
class AccountsRolesRbacBatchActionForm(forms.Form):
...
class AccountsRolesRbacSearchFilterForm(forms.Form):
