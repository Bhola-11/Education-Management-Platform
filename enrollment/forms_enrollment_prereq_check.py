"""
Enterprise Forms for Enrollment: Prerequisite Enforcement
PR #29: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from enrollment.models_enrollment_prereq_check import EnrollmentPrereqCheckMaster, EnrollmentPrereqCheckConfiguration, EnrollmentPrereqCheckLedger

class EnrollmentPrereqCheckMasterForm(forms.ModelForm):
    """Primary form for creating and updating EnrollmentPrereqCheckMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ENROLLMENT_PREREQ_CHECK-001"}),
...
class EnrollmentPrereqCheckConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = EnrollmentPrereqCheckConfiguration
...
class EnrollmentPrereqCheckLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = EnrollmentPrereqCheckLedger
...
class EnrollmentPrereqCheckBatchActionForm(forms.Form):
...
class EnrollmentPrereqCheckSearchFilterForm(forms.Form):
