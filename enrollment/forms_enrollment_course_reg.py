"""
Enterprise Forms for Enrollment: Course Registration
PR #28: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from enrollment.models_enrollment_course_reg import EnrollmentCourseRegMaster, EnrollmentCourseRegConfiguration, EnrollmentCourseRegLedger

class EnrollmentCourseRegMasterForm(forms.ModelForm):
    """Primary form for creating and updating EnrollmentCourseRegMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ENROLLMENT_COURSE_REG-001"}),
...
class EnrollmentCourseRegConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = EnrollmentCourseRegConfiguration
...
class EnrollmentCourseRegLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = EnrollmentCourseRegLedger
...
class EnrollmentCourseRegBatchActionForm(forms.Form):
...
class EnrollmentCourseRegSearchFilterForm(forms.Form):
