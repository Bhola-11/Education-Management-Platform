"""
Enterprise Forms for Enrollment: Application Decisioning
PR #27: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from enrollment.models_enrollment_review import EnrollmentReviewMaster, EnrollmentReviewConfiguration, EnrollmentReviewLedger

class EnrollmentReviewMasterForm(forms.ModelForm):
    """Primary form for creating and updating EnrollmentReviewMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ENROLLMENT_REVIEW-001"}),
...
class EnrollmentReviewConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = EnrollmentReviewConfiguration
...
class EnrollmentReviewLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = EnrollmentReviewLedger
...
class EnrollmentReviewBatchActionForm(forms.Form):
...
class EnrollmentReviewSearchFilterForm(forms.Form):
