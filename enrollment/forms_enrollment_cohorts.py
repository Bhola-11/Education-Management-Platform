"""
Enterprise Forms for Enrollment: Cohorts & Sections
PR #30: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from enrollment.models_enrollment_cohorts import EnrollmentCohortsMaster, EnrollmentCohortsConfiguration, EnrollmentCohortsLedger

class EnrollmentCohortsMasterForm(forms.ModelForm):
    """Primary form for creating and updating EnrollmentCohortsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ENROLLMENT_COHORTS-001"}),
...
class EnrollmentCohortsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = EnrollmentCohortsConfiguration
...
class EnrollmentCohortsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = EnrollmentCohortsLedger
...
class EnrollmentCohortsBatchActionForm(forms.Form):
...
class EnrollmentCohortsSearchFilterForm(forms.Form):
