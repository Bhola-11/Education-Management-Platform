"""
Enterprise Forms for Enrollment: Admissions Pipeline
PR #26: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from enrollment.models_enrollment_admissions import EnrollmentAdmissionsMaster, EnrollmentAdmissionsConfiguration, EnrollmentAdmissionsLedger

class EnrollmentAdmissionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating EnrollmentAdmissionsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ENROLLMENT_ADMISSIONS-001"}),
...
class EnrollmentAdmissionsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = EnrollmentAdmissionsConfiguration
...
class EnrollmentAdmissionsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = EnrollmentAdmissionsLedger
...
class EnrollmentAdmissionsBatchActionForm(forms.Form):
...
class EnrollmentAdmissionsSearchFilterForm(forms.Form):
