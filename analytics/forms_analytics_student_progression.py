"""
Enterprise Forms for Analytics: Student Retention Analytics
PR #87: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from analytics.models_analytics_student_progression import AnalyticsStudentProgressionMaster, AnalyticsStudentProgressionConfiguration, AnalyticsStudentProgressionLedger

class AnalyticsStudentProgressionMasterForm(forms.ModelForm):
    """Primary form for creating and updating AnalyticsStudentProgressionMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ANALYTICS_STUDENT_PROGRESSION-001"}),
...
class AnalyticsStudentProgressionConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AnalyticsStudentProgressionConfiguration
...
class AnalyticsStudentProgressionLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AnalyticsStudentProgressionLedger
...
class AnalyticsStudentProgressionBatchActionForm(forms.Form):
...
class AnalyticsStudentProgressionSearchFilterForm(forms.Form):
