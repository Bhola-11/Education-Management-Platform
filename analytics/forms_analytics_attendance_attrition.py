"""
Enterprise Forms for Analytics: Attendance Attrition Models
PR #89: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from analytics.models_analytics_attendance_attrition import AnalyticsAttendanceAttritionMaster, AnalyticsAttendanceAttritionConfiguration, AnalyticsAttendanceAttritionLedger

class AnalyticsAttendanceAttritionMasterForm(forms.ModelForm):
    """Primary form for creating and updating AnalyticsAttendanceAttritionMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ANALYTICS_ATTENDANCE_ATTRITION-001"}),
...
class AnalyticsAttendanceAttritionConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AnalyticsAttendanceAttritionConfiguration
...
class AnalyticsAttendanceAttritionLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AnalyticsAttendanceAttritionLedger
...
class AnalyticsAttendanceAttritionBatchActionForm(forms.Form):
...
class AnalyticsAttendanceAttritionSearchFilterForm(forms.Form):
