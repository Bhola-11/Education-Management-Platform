"""
Enterprise Forms for Analytics: Enterprise Export Pipeline
PR #90: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from analytics.models_analytics_export_pipeline import AnalyticsExportPipelineMaster, AnalyticsExportPipelineConfiguration, AnalyticsExportPipelineLedger

class AnalyticsExportPipelineMasterForm(forms.ModelForm):
    """Primary form for creating and updating AnalyticsExportPipelineMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ANALYTICS_EXPORT_PIPELINE-001"}),
...
class AnalyticsExportPipelineConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AnalyticsExportPipelineConfiguration
...
class AnalyticsExportPipelineLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AnalyticsExportPipelineLedger
...
class AnalyticsExportPipelineBatchActionForm(forms.Form):
...
class AnalyticsExportPipelineSearchFilterForm(forms.Form):
