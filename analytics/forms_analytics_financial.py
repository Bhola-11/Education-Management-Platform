"""
Enterprise Forms for Analytics: Institutional Financial Analytics
PR #88: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from analytics.models_analytics_financial import AnalyticsFinancialMaster, AnalyticsFinancialConfiguration, AnalyticsFinancialLedger

class AnalyticsFinancialMasterForm(forms.ModelForm):
    """Primary form for creating and updating AnalyticsFinancialMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ANALYTICS_FINANCIAL-001"}),
...
class AnalyticsFinancialConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AnalyticsFinancialConfiguration
...
class AnalyticsFinancialLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AnalyticsFinancialLedger
...
class AnalyticsFinancialBatchActionForm(forms.Form):
...
class AnalyticsFinancialSearchFilterForm(forms.Form):
