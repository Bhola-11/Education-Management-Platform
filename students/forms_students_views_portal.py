"""
Enterprise Forms for Students: Student Portal & Directory
PR #20: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_views_portal import StudentsViewsPortalMaster, StudentsViewsPortalConfiguration, StudentsViewsPortalLedger

class StudentsViewsPortalMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsViewsPortalMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_VIEWS_PORTAL-001"}),
...
class StudentsViewsPortalConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsViewsPortalConfiguration
...
class StudentsViewsPortalLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsViewsPortalLedger
...
class StudentsViewsPortalBatchActionForm(forms.Form):
...
class StudentsViewsPortalSearchFilterForm(forms.Form):
