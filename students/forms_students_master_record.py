"""
Enterprise Forms for Students: Student Master Record
PR #15: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_master_record import StudentsMasterRecordMaster, StudentsMasterRecordConfiguration, StudentsMasterRecordLedger

class StudentsMasterRecordMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsMasterRecordMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_MASTER_RECORD-001"}),
...
class StudentsMasterRecordConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsMasterRecordConfiguration
...
class StudentsMasterRecordLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsMasterRecordLedger
...
class StudentsMasterRecordBatchActionForm(forms.Form):
...
class StudentsMasterRecordSearchFilterForm(forms.Form):
