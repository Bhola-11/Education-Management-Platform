"""
Enterprise Forms for Students: Students & Enrollment Tests
PR #96: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_and_enrollment_suite import StudentsAndEnrollmentSuiteMaster, StudentsAndEnrollmentSuiteConfiguration, StudentsAndEnrollmentSuiteLedger

class StudentsAndEnrollmentSuiteMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsAndEnrollmentSuiteMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_AND_ENROLLMENT_SUITE-001"}),
...
class StudentsAndEnrollmentSuiteConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsAndEnrollmentSuiteConfiguration
...
class StudentsAndEnrollmentSuiteLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsAndEnrollmentSuiteLedger
...
class StudentsAndEnrollmentSuiteBatchActionForm(forms.Form):
...
class StudentsAndEnrollmentSuiteSearchFilterForm(forms.Form):
