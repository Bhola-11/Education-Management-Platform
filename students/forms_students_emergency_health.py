"""
Enterprise Forms for Students: Student Health & Safety
PR #18: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_emergency_health import StudentsEmergencyHealthMaster, StudentsEmergencyHealthConfiguration, StudentsEmergencyHealthLedger

class StudentsEmergencyHealthMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsEmergencyHealthMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_EMERGENCY_HEALTH-001"}),
...
class StudentsEmergencyHealthConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsEmergencyHealthConfiguration
...
class StudentsEmergencyHealthLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsEmergencyHealthLedger
...
class StudentsEmergencyHealthBatchActionForm(forms.Form):
...
class StudentsEmergencyHealthSearchFilterForm(forms.Form):
