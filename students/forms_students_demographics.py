"""
Enterprise Forms for Students: Student Demographics
PR #16: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_demographics import StudentsDemographicsMaster, StudentsDemographicsConfiguration, StudentsDemographicsLedger

class StudentsDemographicsMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsDemographicsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_DEMOGRAPHICS-001"}),
...
class StudentsDemographicsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsDemographicsConfiguration
...
class StudentsDemographicsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsDemographicsLedger
...
class StudentsDemographicsBatchActionForm(forms.Form):
...
class StudentsDemographicsSearchFilterForm(forms.Form):
