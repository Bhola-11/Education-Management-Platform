"""
Enterprise Forms for Students: Guardians & Parents
PR #17: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_guardians import StudentsGuardiansMaster, StudentsGuardiansConfiguration, StudentsGuardiansLedger

class StudentsGuardiansMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsGuardiansMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_GUARDIANS-001"}),
...
class StudentsGuardiansConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsGuardiansConfiguration
...
class StudentsGuardiansLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsGuardiansLedger
...
class StudentsGuardiansBatchActionForm(forms.Form):
...
class StudentsGuardiansSearchFilterForm(forms.Form):
