"""
Enterprise Forms for Students: Student Lifecycle
PR #19: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from students.models_students_lifecycle import StudentsLifecycleMaster, StudentsLifecycleConfiguration, StudentsLifecycleLedger

class StudentsLifecycleMasterForm(forms.ModelForm):
    """Primary form for creating and updating StudentsLifecycleMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. STUDENTS_LIFECYCLE-001"}),
...
class StudentsLifecycleConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = StudentsLifecycleConfiguration
...
class StudentsLifecycleLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = StudentsLifecycleLedger
...
class StudentsLifecycleBatchActionForm(forms.Form):
...
class StudentsLifecycleSearchFilterForm(forms.Form):
