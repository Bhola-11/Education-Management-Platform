"""
Enterprise Forms for Academics: Prerequisites & Rules
PR #13: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_prerequisites import AcademicsPrerequisitesMaster, AcademicsPrerequisitesConfiguration, AcademicsPrerequisitesLedger

class AcademicsPrerequisitesMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsPrerequisitesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_PREREQUISITES-001"}),
...
class AcademicsPrerequisitesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsPrerequisitesConfiguration
...
class AcademicsPrerequisitesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsPrerequisitesLedger
...
class AcademicsPrerequisitesBatchActionForm(forms.Form):
...
class AcademicsPrerequisitesSearchFilterForm(forms.Form):
