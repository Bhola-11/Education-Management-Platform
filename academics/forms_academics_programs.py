"""
Enterprise Forms for Academics: Programs & Degrees
PR #9: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_programs import AcademicsProgramsMaster, AcademicsProgramsConfiguration, AcademicsProgramsLedger

class AcademicsProgramsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsProgramsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_PROGRAMS-001"}),
...
class AcademicsProgramsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsProgramsConfiguration
...
class AcademicsProgramsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsProgramsLedger
...
class AcademicsProgramsBatchActionForm(forms.Form):
...
class AcademicsProgramsSearchFilterForm(forms.Form):
