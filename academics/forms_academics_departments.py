"""
Enterprise Forms for Academics: Departments & Faculties
PR #8: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_departments import AcademicsDepartmentsMaster, AcademicsDepartmentsConfiguration, AcademicsDepartmentsLedger

class AcademicsDepartmentsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsDepartmentsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_DEPARTMENTS-001"}),
...
class AcademicsDepartmentsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsDepartmentsConfiguration
...
class AcademicsDepartmentsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsDepartmentsLedger
...
class AcademicsDepartmentsBatchActionForm(forms.Form):
...
class AcademicsDepartmentsSearchFilterForm(forms.Form):
