"""
Enterprise Forms for Academics: Facilities & Classrooms
PR #14: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_classrooms import AcademicsClassroomsMaster, AcademicsClassroomsConfiguration, AcademicsClassroomsLedger

class AcademicsClassroomsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsClassroomsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_CLASSROOMS-001"}),
...
class AcademicsClassroomsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsClassroomsConfiguration
...
class AcademicsClassroomsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsClassroomsLedger
...
class AcademicsClassroomsBatchActionForm(forms.Form):
...
class AcademicsClassroomsSearchFilterForm(forms.Form):
