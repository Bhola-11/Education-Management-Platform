"""
Enterprise Forms for Academics: Course Catalog
PR #11: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_courses import AcademicsCoursesMaster, AcademicsCoursesConfiguration, AcademicsCoursesLedger

class AcademicsCoursesMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsCoursesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_COURSES-001"}),
...
class AcademicsCoursesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsCoursesConfiguration
...
class AcademicsCoursesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsCoursesLedger
...
class AcademicsCoursesBatchActionForm(forms.Form):
...
class AcademicsCoursesSearchFilterForm(forms.Form):
