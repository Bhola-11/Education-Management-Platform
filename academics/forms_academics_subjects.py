"""
Enterprise Forms for Academics: Subject Architecture
PR #12: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_subjects import AcademicsSubjectsMaster, AcademicsSubjectsConfiguration, AcademicsSubjectsLedger

class AcademicsSubjectsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsSubjectsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_SUBJECTS-001"}),
...
class AcademicsSubjectsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsSubjectsConfiguration
...
class AcademicsSubjectsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsSubjectsLedger
...
class AcademicsSubjectsBatchActionForm(forms.Form):
...
class AcademicsSubjectsSearchFilterForm(forms.Form):
