"""
Enterprise Forms for Academics: Academic Calendar
PR #10: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from academics.models_academics_calendar import AcademicsCalendarMaster, AcademicsCalendarConfiguration, AcademicsCalendarLedger

class AcademicsCalendarMasterForm(forms.ModelForm):
    """Primary form for creating and updating AcademicsCalendarMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ACADEMICS_CALENDAR-001"}),
...
class AcademicsCalendarConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AcademicsCalendarConfiguration
...
class AcademicsCalendarLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AcademicsCalendarLedger
...
class AcademicsCalendarBatchActionForm(forms.Form):
...
class AcademicsCalendarSearchFilterForm(forms.Form):
