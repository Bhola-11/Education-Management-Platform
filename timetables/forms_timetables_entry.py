"""
Enterprise Forms for Timetables: Timetable Matrix
PR #32: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from timetables.models_timetables_entry import TimetablesEntryMaster, TimetablesEntryConfiguration, TimetablesEntryLedger

class TimetablesEntryMasterForm(forms.ModelForm):
    """Primary form for creating and updating TimetablesEntryMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TIMETABLES_ENTRY-001"}),
...
class TimetablesEntryConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TimetablesEntryConfiguration
...
class TimetablesEntryLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TimetablesEntryLedger
...
class TimetablesEntryBatchActionForm(forms.Form):
...
class TimetablesEntrySearchFilterForm(forms.Form):
