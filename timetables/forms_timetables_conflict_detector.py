"""
Enterprise Forms for Timetables: Schedule Conflict Solver
PR #33: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from timetables.models_timetables_conflict_detector import TimetablesConflictDetectorMaster, TimetablesConflictDetectorConfiguration, TimetablesConflictDetectorLedger

class TimetablesConflictDetectorMasterForm(forms.ModelForm):
    """Primary form for creating and updating TimetablesConflictDetectorMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TIMETABLES_CONFLICT_DETECTOR-001"}),
...
class TimetablesConflictDetectorConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TimetablesConflictDetectorConfiguration
...
class TimetablesConflictDetectorLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TimetablesConflictDetectorLedger
...
class TimetablesConflictDetectorBatchActionForm(forms.Form):
...
class TimetablesConflictDetectorSearchFilterForm(forms.Form):
