"""
Enterprise Forms for Timetables: Timetable Visualizer
PR #35: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from timetables.models_timetables_views_grid import TimetablesViewsGridMaster, TimetablesViewsGridConfiguration, TimetablesViewsGridLedger

class TimetablesViewsGridMasterForm(forms.ModelForm):
    """Primary form for creating and updating TimetablesViewsGridMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TIMETABLES_VIEWS_GRID-001"}),
...
class TimetablesViewsGridConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TimetablesViewsGridConfiguration
...
class TimetablesViewsGridLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TimetablesViewsGridLedger
...
class TimetablesViewsGridBatchActionForm(forms.Form):
...
class TimetablesViewsGridSearchFilterForm(forms.Form):
