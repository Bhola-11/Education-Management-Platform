"""
Enterprise Forms for Timetables: Faculty Substitutions
PR #34: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from timetables.models_timetables_substitutions import TimetablesSubstitutionsMaster, TimetablesSubstitutionsConfiguration, TimetablesSubstitutionsLedger

class TimetablesSubstitutionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating TimetablesSubstitutionsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TIMETABLES_SUBSTITUTIONS-001"}),
...
class TimetablesSubstitutionsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TimetablesSubstitutionsConfiguration
...
class TimetablesSubstitutionsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TimetablesSubstitutionsLedger
...
class TimetablesSubstitutionsBatchActionForm(forms.Form):
...
class TimetablesSubstitutionsSearchFilterForm(forms.Form):
