"""
Enterprise Forms for Timetables: Time Slot Architecture
PR #31: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from timetables.models_timetables_slots import TimetablesSlotsMaster, TimetablesSlotsConfiguration, TimetablesSlotsLedger

class TimetablesSlotsMasterForm(forms.ModelForm):
    """Primary form for creating and updating TimetablesSlotsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TIMETABLES_SLOTS-001"}),
...
class TimetablesSlotsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TimetablesSlotsConfiguration
...
class TimetablesSlotsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TimetablesSlotsLedger
...
class TimetablesSlotsBatchActionForm(forms.Form):
...
class TimetablesSlotsSearchFilterForm(forms.Form):
