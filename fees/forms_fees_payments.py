"""
Enterprise Forms for Fees: Payment Processing
PR #62: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_payments import FeesPaymentsMaster, FeesPaymentsConfiguration, FeesPaymentsLedger

class FeesPaymentsMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesPaymentsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_PAYMENTS-001"}),
...
class FeesPaymentsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesPaymentsConfiguration
...
class FeesPaymentsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesPaymentsLedger
...
class FeesPaymentsBatchActionForm(forms.Form):
...
class FeesPaymentsSearchFilterForm(forms.Form):
