"""
Enterprise Forms for Fees: Scholarships & Waivers
PR #61: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_scholarships import FeesScholarshipsMaster, FeesScholarshipsConfiguration, FeesScholarshipsLedger

class FeesScholarshipsMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesScholarshipsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_SCHOLARSHIPS-001"}),
...
class FeesScholarshipsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesScholarshipsConfiguration
...
class FeesScholarshipsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesScholarshipsLedger
...
class FeesScholarshipsBatchActionForm(forms.Form):
...
class FeesScholarshipsSearchFilterForm(forms.Form):
