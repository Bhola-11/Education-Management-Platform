"""
Enterprise Forms for Fees: Fee Structures & Pricing
PR #58: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_structures import FeesStructuresMaster, FeesStructuresConfiguration, FeesStructuresLedger

class FeesStructuresMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesStructuresMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_STRUCTURES-001"}),
...
class FeesStructuresConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesStructuresConfiguration
...
class FeesStructuresLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesStructuresLedger
...
class FeesStructuresBatchActionForm(forms.Form):
...
class FeesStructuresSearchFilterForm(forms.Form):
