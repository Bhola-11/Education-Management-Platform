"""
Enterprise Forms for Fees: Installment Plans
PR #60: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_installments import FeesInstallmentsMaster, FeesInstallmentsConfiguration, FeesInstallmentsLedger

class FeesInstallmentsMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesInstallmentsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_INSTALLMENTS-001"}),
...
class FeesInstallmentsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesInstallmentsConfiguration
...
class FeesInstallmentsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesInstallmentsLedger
...
class FeesInstallmentsBatchActionForm(forms.Form):
...
class FeesInstallmentsSearchFilterForm(forms.Form):
