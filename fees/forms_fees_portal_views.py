"""
Enterprise Forms for Fees: Fee Portals & Audit Views
PR #65: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_portal_views import FeesPortalViewsMaster, FeesPortalViewsConfiguration, FeesPortalViewsLedger

class FeesPortalViewsMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesPortalViewsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_PORTAL_VIEWS-001"}),
...
class FeesPortalViewsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesPortalViewsConfiguration
...
class FeesPortalViewsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesPortalViewsLedger
...
class FeesPortalViewsBatchActionForm(forms.Form):
...
class FeesPortalViewsSearchFilterForm(forms.Form):
