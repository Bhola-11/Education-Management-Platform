"""
Enterprise Forms for Fees: Fee Ledger & Accounting
PR #63: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_reconciliation import FeesReconciliationMaster, FeesReconciliationConfiguration, FeesReconciliationLedger

class FeesReconciliationMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesReconciliationMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_RECONCILIATION-001"}),
...
class FeesReconciliationConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesReconciliationConfiguration
...
class FeesReconciliationLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesReconciliationLedger
...
class FeesReconciliationBatchActionForm(forms.Form):
...
class FeesReconciliationSearchFilterForm(forms.Form):
