"""
Enterprise Forms for Fees: Student Fee Invoicing
PR #59: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_invoicing import FeesInvoicingMaster, FeesInvoicingConfiguration, FeesInvoicingLedger

class FeesInvoicingMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesInvoicingMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_INVOICING-001"}),
...
class FeesInvoicingConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesInvoicingConfiguration
...
class FeesInvoicingLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesInvoicingLedger
...
class FeesInvoicingBatchActionForm(forms.Form):
...
class FeesInvoicingSearchFilterForm(forms.Form):
