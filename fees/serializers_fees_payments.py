"""
Data Transfer Objects & Serializers for Fees: Payment Processing
PR #62: Structured Data Mapping and Validation DTOs.
"""

from decimal import Decimal
from typing import Dict, Any, List
from fees.models_fees_payments import FeesPaymentsMaster, FeesPaymentsConfiguration

class FeesPaymentsMasterDTO:
    """Data Transfer Object representing a validated FeesPaymentsMaster instance."""
    def __init__(self, record: FeesPaymentsMaster):
