"""
Enterprise Forms for Fees: Late Fee Penalties
PR #64: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from fees.models_fees_penalties import FeesPenaltiesMaster, FeesPenaltiesConfiguration, FeesPenaltiesLedger

class FeesPenaltiesMasterForm(forms.ModelForm):
    """Primary form for creating and updating FeesPenaltiesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. FEES_PENALTIES-001"}),
...
class FeesPenaltiesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = FeesPenaltiesConfiguration
...
class FeesPenaltiesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = FeesPenaltiesLedger
...
class FeesPenaltiesBatchActionForm(forms.Form):
...
class FeesPenaltiesSearchFilterForm(forms.Form):
