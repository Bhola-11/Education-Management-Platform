"""
Enterprise Forms for Certificates: Certificate Template Designer
PR #72: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from certificates.models_certificates_templates import CertificatesTemplatesMaster, CertificatesTemplatesConfiguration, CertificatesTemplatesLedger

class CertificatesTemplatesMasterForm(forms.ModelForm):
    """Primary form for creating and updating CertificatesTemplatesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CERTIFICATES_TEMPLATES-001"}),
...
class CertificatesTemplatesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CertificatesTemplatesConfiguration
...
class CertificatesTemplatesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CertificatesTemplatesLedger
...
class CertificatesTemplatesBatchActionForm(forms.Form):
...
class CertificatesTemplatesSearchFilterForm(forms.Form):
