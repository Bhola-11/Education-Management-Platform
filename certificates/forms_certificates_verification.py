"""
Enterprise Forms for Certificates: Cryptographic Verification
PR #74: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from certificates.models_certificates_verification import CertificatesVerificationMaster, CertificatesVerificationConfiguration, CertificatesVerificationLedger

class CertificatesVerificationMasterForm(forms.ModelForm):
    """Primary form for creating and updating CertificatesVerificationMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CERTIFICATES_VERIFICATION-001"}),
...
class CertificatesVerificationConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CertificatesVerificationConfiguration
...
class CertificatesVerificationLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CertificatesVerificationLedger
...
class CertificatesVerificationBatchActionForm(forms.Form):
...
class CertificatesVerificationSearchFilterForm(forms.Form):
