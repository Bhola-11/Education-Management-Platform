"""
Enterprise Forms for Certificates: Certificate Issuance Pipeline
PR #73: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from certificates.models_certificates_issuance import CertificatesIssuanceMaster, CertificatesIssuanceConfiguration, CertificatesIssuanceLedger

class CertificatesIssuanceMasterForm(forms.ModelForm):
    """Primary form for creating and updating CertificatesIssuanceMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CERTIFICATES_ISSUANCE-001"}),
...
class CertificatesIssuanceConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CertificatesIssuanceConfiguration
...
class CertificatesIssuanceLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CertificatesIssuanceLedger
...
class CertificatesIssuanceBatchActionForm(forms.Form):
...
class CertificatesIssuanceSearchFilterForm(forms.Form):
