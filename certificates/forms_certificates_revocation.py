"""
Enterprise Forms for Certificates: Certificate Revocation Registry
PR #75: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from certificates.models_certificates_revocation import CertificatesRevocationMaster, CertificatesRevocationConfiguration, CertificatesRevocationLedger

class CertificatesRevocationMasterForm(forms.ModelForm):
    """Primary form for creating and updating CertificatesRevocationMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CERTIFICATES_REVOCATION-001"}),
...
class CertificatesRevocationConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CertificatesRevocationConfiguration
...
class CertificatesRevocationLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CertificatesRevocationLedger
...
class CertificatesRevocationBatchActionForm(forms.Form):
...
class CertificatesRevocationSearchFilterForm(forms.Form):
