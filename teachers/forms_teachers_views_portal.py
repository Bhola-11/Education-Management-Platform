"""
Enterprise Forms for Teachers: Faculty Portal & Directory
PR #25: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from teachers.models_teachers_views_portal import TeachersViewsPortalMaster, TeachersViewsPortalConfiguration, TeachersViewsPortalLedger

class TeachersViewsPortalMasterForm(forms.ModelForm):
    """Primary form for creating and updating TeachersViewsPortalMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TEACHERS_VIEWS_PORTAL-001"}),
...
class TeachersViewsPortalConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TeachersViewsPortalConfiguration
...
class TeachersViewsPortalLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TeachersViewsPortalLedger
...
class TeachersViewsPortalBatchActionForm(forms.Form):
...
class TeachersViewsPortalSearchFilterForm(forms.Form):
