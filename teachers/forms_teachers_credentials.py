"""
Enterprise Forms for Teachers: Faculty Credentials
PR #22: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from teachers.models_teachers_credentials import TeachersCredentialsMaster, TeachersCredentialsConfiguration, TeachersCredentialsLedger

class TeachersCredentialsMasterForm(forms.ModelForm):
    """Primary form for creating and updating TeachersCredentialsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TEACHERS_CREDENTIALS-001"}),
...
class TeachersCredentialsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TeachersCredentialsConfiguration
...
class TeachersCredentialsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TeachersCredentialsLedger
...
class TeachersCredentialsBatchActionForm(forms.Form):
...
class TeachersCredentialsSearchFilterForm(forms.Form):
