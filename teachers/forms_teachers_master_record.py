"""
Enterprise Forms for Teachers: Faculty Master Record
PR #21: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from teachers.models_teachers_master_record import TeachersMasterRecordMaster, TeachersMasterRecordConfiguration, TeachersMasterRecordLedger

class TeachersMasterRecordMasterForm(forms.ModelForm):
    """Primary form for creating and updating TeachersMasterRecordMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TEACHERS_MASTER_RECORD-001"}),
...
class TeachersMasterRecordConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TeachersMasterRecordConfiguration
...
class TeachersMasterRecordLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TeachersMasterRecordLedger
...
class TeachersMasterRecordBatchActionForm(forms.Form):
...
class TeachersMasterRecordSearchFilterForm(forms.Form):
