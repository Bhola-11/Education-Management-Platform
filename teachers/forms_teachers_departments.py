"""
Enterprise Forms for Teachers: Department Affiliations
PR #23: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from teachers.models_teachers_departments import TeachersDepartmentsMaster, TeachersDepartmentsConfiguration, TeachersDepartmentsLedger

class TeachersDepartmentsMasterForm(forms.ModelForm):
    """Primary form for creating and updating TeachersDepartmentsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TEACHERS_DEPARTMENTS-001"}),
...
class TeachersDepartmentsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TeachersDepartmentsConfiguration
...
class TeachersDepartmentsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TeachersDepartmentsLedger
...
class TeachersDepartmentsBatchActionForm(forms.Form):
...
class TeachersDepartmentsSearchFilterForm(forms.Form):
