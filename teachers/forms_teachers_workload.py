"""
Enterprise Forms for Teachers: Faculty Workload
PR #24: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from teachers.models_teachers_workload import TeachersWorkloadMaster, TeachersWorkloadConfiguration, TeachersWorkloadLedger

class TeachersWorkloadMasterForm(forms.ModelForm):
    """Primary form for creating and updating TeachersWorkloadMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. TEACHERS_WORKLOAD-001"}),
...
class TeachersWorkloadConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = TeachersWorkloadConfiguration
...
class TeachersWorkloadLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = TeachersWorkloadLedger
...
class TeachersWorkloadBatchActionForm(forms.Form):
...
class TeachersWorkloadSearchFilterForm(forms.Form):
