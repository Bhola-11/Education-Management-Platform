"""
Enterprise Forms for Grading: Marks Moderation Workflow
PR #54: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_moderation import GradingModerationMaster, GradingModerationConfiguration, GradingModerationLedger

class GradingModerationMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingModerationMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_MODERATION-001"}),
...
class GradingModerationConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingModerationConfiguration
...
class GradingModerationLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingModerationLedger
...
class GradingModerationBatchActionForm(forms.Form):
...
class GradingModerationSearchFilterForm(forms.Form):
