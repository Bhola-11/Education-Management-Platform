"""
Enterprise Forms for Grading: Official Academic Transcripts
PR #56: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_transcripts import GradingTranscriptsMaster, GradingTranscriptsConfiguration, GradingTranscriptsLedger

class GradingTranscriptsMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingTranscriptsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_TRANSCRIPTS-001"}),
...
class GradingTranscriptsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingTranscriptsConfiguration
...
class GradingTranscriptsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingTranscriptsLedger
...
class GradingTranscriptsBatchActionForm(forms.Form):
...
class GradingTranscriptsSearchFilterForm(forms.Form):
