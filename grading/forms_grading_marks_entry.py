"""
Enterprise Forms for Grading: Marks Evaluation Sheet
PR #53: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_marks_entry import GradingMarksEntryMaster, GradingMarksEntryConfiguration, GradingMarksEntryLedger

class GradingMarksEntryMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingMarksEntryMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_MARKS_ENTRY-001"}),
...
class GradingMarksEntryConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingMarksEntryConfiguration
...
class GradingMarksEntryLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingMarksEntryLedger
...
class GradingMarksEntryBatchActionForm(forms.Form):
...
class GradingMarksEntrySearchFilterForm(forms.Form):
