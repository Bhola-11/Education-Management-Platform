"""
Enterprise Forms for Grading: Rank Lists & Distinctions
PR #57: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_rank_lists import GradingRankListsMaster, GradingRankListsConfiguration, GradingRankListsLedger

class GradingRankListsMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingRankListsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_RANK_LISTS-001"}),
...
class GradingRankListsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingRankListsConfiguration
...
class GradingRankListsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingRankListsLedger
...
class GradingRankListsBatchActionForm(forms.Form):
...
class GradingRankListsSearchFilterForm(forms.Form):
