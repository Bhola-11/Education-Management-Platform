"""
Enterprise Forms for Grading: Grade Scales & Rules
PR #52: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_scales import GradingScalesMaster, GradingScalesConfiguration, GradingScalesLedger

class GradingScalesMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingScalesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_SCALES-001"}),
...
class GradingScalesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingScalesConfiguration
...
class GradingScalesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingScalesLedger
...
class GradingScalesBatchActionForm(forms.Form):
...
class GradingScalesSearchFilterForm(forms.Form):
