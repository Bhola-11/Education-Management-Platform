"""
Enterprise Forms for Grading: GPA/CGPA Calculation
PR #55: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_gpa_engine import GradingGpaEngineMaster, GradingGpaEngineConfiguration, GradingGpaEngineLedger

class GradingGpaEngineMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingGpaEngineMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_GPA_ENGINE-001"}),
...
class GradingGpaEngineConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingGpaEngineConfiguration
...
class GradingGpaEngineLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingGpaEngineLedger
...
class GradingGpaEngineBatchActionForm(forms.Form):
...
class GradingGpaEngineSearchFilterForm(forms.Form):
