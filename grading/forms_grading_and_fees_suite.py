"""
Enterprise Forms for Grading: Grading & Fees Tests
PR #97: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from grading.models_grading_and_fees_suite import GradingAndFeesSuiteMaster, GradingAndFeesSuiteConfiguration, GradingAndFeesSuiteLedger

class GradingAndFeesSuiteMasterForm(forms.ModelForm):
    """Primary form for creating and updating GradingAndFeesSuiteMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. GRADING_AND_FEES_SUITE-001"}),
...
class GradingAndFeesSuiteConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = GradingAndFeesSuiteConfiguration
...
class GradingAndFeesSuiteLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = GradingAndFeesSuiteLedger
...
class GradingAndFeesSuiteBatchActionForm(forms.Form):
...
class GradingAndFeesSuiteSearchFilterForm(forms.Form):
