"""
Enterprise Forms for Core: Security & Penetration Tests
PR #99: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from core.models_security_and_permissions_suite import SecurityAndPermissionsSuiteMaster, SecurityAndPermissionsSuiteConfiguration, SecurityAndPermissionsSuiteLedger

class SecurityAndPermissionsSuiteMasterForm(forms.ModelForm):
    """Primary form for creating and updating SecurityAndPermissionsSuiteMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. SECURITY_AND_PERMISSIONS_SUITE-001"}),
...
class SecurityAndPermissionsSuiteConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = SecurityAndPermissionsSuiteConfiguration
...
class SecurityAndPermissionsSuiteLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = SecurityAndPermissionsSuiteLedger
...
class SecurityAndPermissionsSuiteBatchActionForm(forms.Form):
...
class SecurityAndPermissionsSuiteSearchFilterForm(forms.Form):
