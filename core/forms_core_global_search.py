"""
Enterprise Forms for Core: Global Search Indexer
PR #91: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from core.models_core_global_search import CoreGlobalSearchMaster, CoreGlobalSearchConfiguration, CoreGlobalSearchLedger

class CoreGlobalSearchMasterForm(forms.ModelForm):
    """Primary form for creating and updating CoreGlobalSearchMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CORE_GLOBAL_SEARCH-001"}),
...
class CoreGlobalSearchConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CoreGlobalSearchConfiguration
...
class CoreGlobalSearchLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CoreGlobalSearchLedger
...
class CoreGlobalSearchBatchActionForm(forms.Form):
...
class CoreGlobalSearchSearchFilterForm(forms.Form):
