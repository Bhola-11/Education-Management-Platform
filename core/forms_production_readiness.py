"""
Enterprise Forms for Core: Production Readiness
PR #100: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from core.models_production_readiness import ProductionReadinessMaster, ProductionReadinessConfiguration, ProductionReadinessLedger

class ProductionReadinessMasterForm(forms.ModelForm):
    """Primary form for creating and updating ProductionReadinessMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. PRODUCTION_READINESS-001"}),
...
class ProductionReadinessConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = ProductionReadinessConfiguration
...
class ProductionReadinessLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = ProductionReadinessLedger
...
class ProductionReadinessBatchActionForm(forms.Form):
...
class ProductionReadinessSearchFilterForm(forms.Form):
