"""
Enterprise Forms for Core: Security Audit Trail
PR #92: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from core.models_core_audit_logging import CoreAuditLoggingMaster, CoreAuditLoggingConfiguration, CoreAuditLoggingLedger

class CoreAuditLoggingMasterForm(forms.ModelForm):
    """Primary form for creating and updating CoreAuditLoggingMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CORE_AUDIT_LOGGING-001"}),
...
class CoreAuditLoggingConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CoreAuditLoggingConfiguration
...
class CoreAuditLoggingLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CoreAuditLoggingLedger
...
class CoreAuditLoggingBatchActionForm(forms.Form):
...
class CoreAuditLoggingSearchFilterForm(forms.Form):
