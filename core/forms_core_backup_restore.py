"""
Enterprise Forms for Core: Database Diagnostics & Snapshots
PR #93: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from core.models_core_backup_restore import CoreBackupRestoreMaster, CoreBackupRestoreConfiguration, CoreBackupRestoreLedger

class CoreBackupRestoreMasterForm(forms.ModelForm):
    """Primary form for creating and updating CoreBackupRestoreMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CORE_BACKUP_RESTORE-001"}),
...
class CoreBackupRestoreConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CoreBackupRestoreConfiguration
...
class CoreBackupRestoreLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CoreBackupRestoreLedger
...
class CoreBackupRestoreBatchActionForm(forms.Form):
...
class CoreBackupRestoreSearchFilterForm(forms.Form):
