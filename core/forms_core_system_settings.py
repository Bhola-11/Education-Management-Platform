"""
Enterprise Forms for Core: Institutional Settings
PR #94: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from core.models_core_system_settings import CoreSystemSettingsMaster, CoreSystemSettingsConfiguration, CoreSystemSettingsLedger

class CoreSystemSettingsMasterForm(forms.ModelForm):
    """Primary form for creating and updating CoreSystemSettingsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. CORE_SYSTEM_SETTINGS-001"}),
...
class CoreSystemSettingsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = CoreSystemSettingsConfiguration
...
class CoreSystemSettingsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = CoreSystemSettingsLedger
...
class CoreSystemSettingsBatchActionForm(forms.Form):
...
class CoreSystemSettingsSearchFilterForm(forms.Form):
