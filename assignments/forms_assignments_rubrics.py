"""
Enterprise Forms for Assignments: Evaluation Rubrics
PR #44: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from assignments.models_assignments_rubrics import AssignmentsRubricsMaster, AssignmentsRubricsConfiguration, AssignmentsRubricsLedger

class AssignmentsRubricsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssignmentsRubricsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ASSIGNMENTS_RUBRICS-001"}),
...
class AssignmentsRubricsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AssignmentsRubricsConfiguration
...
class AssignmentsRubricsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AssignmentsRubricsLedger
...
class AssignmentsRubricsBatchActionForm(forms.Form):
...
class AssignmentsRubricsSearchFilterForm(forms.Form):
