"""
Enterprise Forms for Assignments: Student Submissions
PR #43: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from assignments.models_assignments_submissions import AssignmentsSubmissionsMaster, AssignmentsSubmissionsConfiguration, AssignmentsSubmissionsLedger

class AssignmentsSubmissionsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssignmentsSubmissionsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ASSIGNMENTS_SUBMISSIONS-001"}),
...
class AssignmentsSubmissionsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AssignmentsSubmissionsConfiguration
...
class AssignmentsSubmissionsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AssignmentsSubmissionsLedger
...
class AssignmentsSubmissionsBatchActionForm(forms.Form):
...
class AssignmentsSubmissionsSearchFilterForm(forms.Form):
