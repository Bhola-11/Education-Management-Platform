"""
Enterprise Forms for Assignments: Academic Integrity
PR #46: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from assignments.models_assignments_plagiarism import AssignmentsPlagiarismMaster, AssignmentsPlagiarismConfiguration, AssignmentsPlagiarismLedger

class AssignmentsPlagiarismMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssignmentsPlagiarismMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ASSIGNMENTS_PLAGIARISM-001"}),
...
class AssignmentsPlagiarismConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AssignmentsPlagiarismConfiguration
...
class AssignmentsPlagiarismLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AssignmentsPlagiarismLedger
...
class AssignmentsPlagiarismBatchActionForm(forms.Form):
...
class AssignmentsPlagiarismSearchFilterForm(forms.Form):
