"""
Enterprise Forms for Assignments: Assignment Specifications
PR #42: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from assignments.models_assignments_core import AssignmentsCoreMaster, AssignmentsCoreConfiguration, AssignmentsCoreLedger

class AssignmentsCoreMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssignmentsCoreMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ASSIGNMENTS_CORE-001"}),
...
class AssignmentsCoreConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AssignmentsCoreConfiguration
...
class AssignmentsCoreLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AssignmentsCoreLedger
...
class AssignmentsCoreBatchActionForm(forms.Form):
...
class AssignmentsCoreSearchFilterForm(forms.Form):
