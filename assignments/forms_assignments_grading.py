"""
Enterprise Forms for Assignments: Assignment Grading
PR #45: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from assignments.models_assignments_grading import AssignmentsGradingMaster, AssignmentsGradingConfiguration, AssignmentsGradingLedger

class AssignmentsGradingMasterForm(forms.ModelForm):
    """Primary form for creating and updating AssignmentsGradingMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ASSIGNMENTS_GRADING-001"}),
...
class AssignmentsGradingConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AssignmentsGradingConfiguration
...
class AssignmentsGradingLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AssignmentsGradingLedger
...
class AssignmentsGradingBatchActionForm(forms.Form):
...
class AssignmentsGradingSearchFilterForm(forms.Form):
