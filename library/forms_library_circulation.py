"""
Enterprise Forms for Library: Book Circulation Desk
PR #68: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from library.models_library_circulation import LibraryCirculationMaster, LibraryCirculationConfiguration, LibraryCirculationLedger

class LibraryCirculationMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibraryCirculationMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. LIBRARY_CIRCULATION-001"}),
...
class LibraryCirculationConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = LibraryCirculationConfiguration
...
class LibraryCirculationLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = LibraryCirculationLedger
...
class LibraryCirculationBatchActionForm(forms.Form):
...
class LibraryCirculationSearchFilterForm(forms.Form):
