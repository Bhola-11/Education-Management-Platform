"""
Enterprise Forms for Library: OPAC Public Catalog
PR #71: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from library.models_library_opac_views import LibraryOpacViewsMaster, LibraryOpacViewsConfiguration, LibraryOpacViewsLedger

class LibraryOpacViewsMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibraryOpacViewsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. LIBRARY_OPAC_VIEWS-001"}),
...
class LibraryOpacViewsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = LibraryOpacViewsConfiguration
...
class LibraryOpacViewsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = LibraryOpacViewsLedger
...
class LibraryOpacViewsBatchActionForm(forms.Form):
...
class LibraryOpacViewsSearchFilterForm(forms.Form):
