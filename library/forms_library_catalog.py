"""
Enterprise Forms for Library: Library Cataloging
PR #66: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from library.models_library_catalog import LibraryCatalogMaster, LibraryCatalogConfiguration, LibraryCatalogLedger

class LibraryCatalogMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibraryCatalogMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. LIBRARY_CATALOG-001"}),
...
class LibraryCatalogConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = LibraryCatalogConfiguration
...
class LibraryCatalogLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = LibraryCatalogLedger
...
class LibraryCatalogBatchActionForm(forms.Form):
...
class LibraryCatalogSearchFilterForm(forms.Form):
