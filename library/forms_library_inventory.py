"""
Enterprise Forms for Library: Physical Inventory
PR #67: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from library.models_library_inventory import LibraryInventoryMaster, LibraryInventoryConfiguration, LibraryInventoryLedger

class LibraryInventoryMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibraryInventoryMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. LIBRARY_INVENTORY-001"}),
...
class LibraryInventoryConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = LibraryInventoryConfiguration
...
class LibraryInventoryLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = LibraryInventoryLedger
...
class LibraryInventoryBatchActionForm(forms.Form):
...
class LibraryInventorySearchFilterForm(forms.Form):
