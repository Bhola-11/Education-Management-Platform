"""
Enterprise Forms for Library: Library Overdue Fines
PR #70: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from library.models_library_fines import LibraryFinesMaster, LibraryFinesConfiguration, LibraryFinesLedger

class LibraryFinesMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibraryFinesMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. LIBRARY_FINES-001"}),
...
class LibraryFinesConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = LibraryFinesConfiguration
...
class LibraryFinesLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = LibraryFinesLedger
...
class LibraryFinesBatchActionForm(forms.Form):
...
class LibraryFinesSearchFilterForm(forms.Form):
