"""
Enterprise Forms for Library: Reservations & Holds
PR #69: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from library.models_library_reservations import LibraryReservationsMaster, LibraryReservationsConfiguration, LibraryReservationsLedger

class LibraryReservationsMasterForm(forms.ModelForm):
    """Primary form for creating and updating LibraryReservationsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. LIBRARY_RESERVATIONS-001"}),
...
class LibraryReservationsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = LibraryReservationsConfiguration
...
class LibraryReservationsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = LibraryReservationsLedger
...
class LibraryReservationsBatchActionForm(forms.Form):
...
class LibraryReservationsSearchFilterForm(forms.Form):
