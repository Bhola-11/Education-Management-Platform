...
class AttendanceLeaveWorkflowMaster(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_c4ba5ab2_cd"),
            models.Index(fields=["created_at"], name="attend_attend_c4ba5ab2_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_c4ba5ab2_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_c4ba5ab2_dp"),
        ]
...
class AttendanceLeaveWorkflowConfiguration(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_3a55d718_cd"),
            models.Index(fields=["created_at"], name="attend_attend_3a55d718_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_3a55d718_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_3a55d718_dp"),
        ]
...
class AttendanceLeaveWorkflowLedger(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_d21e876f_cd"),
            models.Index(fields=["created_at"], name="attend_attend_d21e876f_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_d21e876f_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_d21e876f_dp"),
        ]
...
class AttendanceLeaveWorkflowAuditTransaction(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_0af9a569_cd"),
            models.Index(fields=["created_at"], name="attend_attend_0af9a569_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_0af9a569_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_0af9a569_dp"),
        ]
...
class AttendanceLeaveWorkflowScheduleMatrix(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_b088c2be_cd"),
            models.Index(fields=["created_at"], name="attend_attend_b088c2be_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_b088c2be_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_b088c2be_dp"),
        ]
...
class AttendanceLeaveWorkflowEvaluationMetric(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_f8807966_cd"),
            models.Index(fields=["created_at"], name="attend_attend_f8807966_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_f8807966_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_f8807966_dp"),
        ]
...
class AttendanceLeaveWorkflowRosterMapping(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_49245002_cd"),
            models.Index(fields=["created_at"], name="attend_attend_49245002_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_49245002_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_49245002_dp"),
        ]
...
class AttendanceLeaveWorkflowVerificationSignature(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_1b6c3542_cd"),
            models.Index(fields=["created_at"], name="attend_attend_1b6c3542_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_1b6c3542_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_1b6c3542_dp"),
        ]
...
class AttendanceLeaveWorkflowNotificationRule(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_760e5fe5_cd"),
            models.Index(fields=["created_at"], name="attend_attend_760e5fe5_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_760e5fe5_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_760e5fe5_dp"),
        ]
...
class AttendanceLeaveWorkflowAnalyticalSnapshot(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_51e973d9_cd"),
            models.Index(fields=["created_at"], name="attend_attend_51e973d9_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_51e973d9_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_51e973d9_dp"),
        ]
...
class AttendanceLeaveWorkflowComplianceLog(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_3bf42287_cd"),
            models.Index(fields=["created_at"], name="attend_attend_3bf42287_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_3bf42287_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_3bf42287_dp"),
        ]
...
class AttendanceLeaveWorkflowIntegrationBridge(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_7490bd28_cd"),
            models.Index(fields=["created_at"], name="attend_attend_7490bd28_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_7490bd28_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_7490bd28_dp"),
        ]
...
class AttendanceLeaveWorkflowSecurityPermit(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_f45ea9c0_cd"),
            models.Index(fields=["created_at"], name="attend_attend_f45ea9c0_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_f45ea9c0_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_f45ea9c0_dp"),
        ]
...
class AttendanceLeaveWorkflowDocumentAttachment(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_cda7e32e_cd"),
            models.Index(fields=["created_at"], name="attend_attend_cda7e32e_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_cda7e32e_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_cda7e32e_dp"),
        ]
...
class AttendanceLeaveWorkflowLifecycleTransition(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_c1dd41fc_cd"),
            models.Index(fields=["created_at"], name="attend_attend_c1dd41fc_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_c1dd41fc_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_c1dd41fc_dp"),
        ]
...
class AttendanceLeaveWorkflowDataArchivalRegistry(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_a394aef1_cd"),
            models.Index(fields=["created_at"], name="attend_attend_a394aef1_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_a394aef1_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_a394aef1_dp"),
        ]
...
class AttendanceLeaveWorkflowTelemetryEventStream(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_513278ca_cd"),
            models.Index(fields=["created_at"], name="attend_attend_513278ca_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_513278ca_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_513278ca_dp"),
        ]
...
class AttendanceLeaveWorkflowAccessGrantMatrix(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_05cbe708_cd"),
            models.Index(fields=["created_at"], name="attend_attend_05cbe708_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_05cbe708_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_05cbe708_dp"),
        ]
...
class AttendanceLeaveWorkflowOperationalQuota(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_55b0ccb6_cd"),
            models.Index(fields=["created_at"], name="attend_attend_55b0ccb6_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_55b0ccb6_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_55b0ccb6_dp"),
        ]
...
class AttendanceLeaveWorkflowWorkflowAuditCheckpoint(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_5b1b885f_cd"),
            models.Index(fields=["created_at"], name="attend_attend_5b1b885f_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_5b1b885f_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_5b1b885f_dp"),
        ]
...
class AttendanceLeaveWorkflowDisasterRecoveryCheckpoint(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_89115305_cd"),
            models.Index(fields=["created_at"], name="attend_attend_89115305_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_89115305_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_89115305_dp"),
        ]
...
class AttendanceLeaveWorkflowSLAComplianceRegister(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_46fc8059_cd"),
            models.Index(fields=["created_at"], name="attend_attend_46fc8059_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_46fc8059_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_46fc8059_dp"),
        ]
...
class AttendanceLeaveWorkflowIncidentReportRegisterQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowIncidentReportRegister."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowIncidentReportRegisterManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowIncidentReportRegister."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowIncidentReportRegisterQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowIncidentReportRegister(models.Model):
    """
    AttendanceLeaveWorkflowIncidentReportRegister: Incident ticketing and remediation tracking register.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowIncidentReportRegisterManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_incidentreportregister"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowIncidentReportRegister")
        verbose_name_plural = _("AttendanceLeaveWorkflowIncidentReportRegisters")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_2a54a350_cd"),
            models.Index(fields=["created_at"], name="attend_attend_2a54a350_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_2a54a350_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_2a54a350_dp"),
        ]
...
class AttendanceLeaveWorkflowBusinessContinuityPlanQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowBusinessContinuityPlan."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowBusinessContinuityPlanManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowBusinessContinuityPlan."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowBusinessContinuityPlanQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowBusinessContinuityPlan(models.Model):
    """
    AttendanceLeaveWorkflowBusinessContinuityPlan: Business continuity procedures and failover plan coordinates.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowBusinessContinuityPlanManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_businesscontinuityplan"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowBusinessContinuityPlan")
        verbose_name_plural = _("AttendanceLeaveWorkflowBusinessContinuityPlans")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_a3e4e566_cd"),
            models.Index(fields=["created_at"], name="attend_attend_a3e4e566_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_a3e4e566_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_a3e4e566_dp"),
        ]
...
class AttendanceLeaveWorkflowGovernanceAttestationRecordQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowGovernanceAttestationRecord."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowGovernanceAttestationRecordManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowGovernanceAttestationRecord."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowGovernanceAttestationRecordQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowGovernanceAttestationRecord(models.Model):
    """
    AttendanceLeaveWorkflowGovernanceAttestationRecord: Formal institutional governance attestations and sign-offs.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowGovernanceAttestationRecordManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_governanceattestationrecord"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowGovernanceAttestationRecord")
        verbose_name_plural = _("AttendanceLeaveWorkflowGovernanceAttestationRecords")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_8d8a8cb0_cd"),
            models.Index(fields=["created_at"], name="attend_attend_8d8a8cb0_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_8d8a8cb0_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_8d8a8cb0_dp"),
        ]
...
class AttendanceLeaveWorkflowRiskMitigationProtocolQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowRiskMitigationProtocol."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowRiskMitigationProtocolManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowRiskMitigationProtocol."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowRiskMitigationProtocolQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowRiskMitigationProtocol(models.Model):
    """
    AttendanceLeaveWorkflowRiskMitigationProtocol: Institutional risk registry, threat scoring, and mitigation control actions.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowRiskMitigationProtocolManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_riskmitigationprotocol"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowRiskMitigationProtocol")
        verbose_name_plural = _("AttendanceLeaveWorkflowRiskMitigationProtocols")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_05628984_cd"),
            models.Index(fields=["created_at"], name="attend_attend_05628984_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_05628984_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_05628984_dp"),
        ]
...
class AttendanceLeaveWorkflowInteroperabilityGatewayQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowInteroperabilityGateway."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowInteroperabilityGatewayManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowInteroperabilityGateway."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowInteroperabilityGatewayQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowInteroperabilityGateway(models.Model):
    """
    AttendanceLeaveWorkflowInteroperabilityGateway: External schema normalization and bidirectional data synchronization gateway.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowInteroperabilityGatewayManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_interoperabilitygateway"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowInteroperabilityGateway")
        verbose_name_plural = _("AttendanceLeaveWorkflowInteroperabilityGateways")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_1af2d5d5_cd"),
            models.Index(fields=["created_at"], name="attend_attend_1af2d5d5_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_1af2d5d5_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_1af2d5d5_dp"),
        ]
...
class AttendanceLeaveWorkflowCapacityForecastIndexQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowCapacityForecastIndex."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowCapacityForecastIndexManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowCapacityForecastIndex."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowCapacityForecastIndexQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowCapacityForecastIndex(models.Model):
    """
    AttendanceLeaveWorkflowCapacityForecastIndex: Predictive demand forecasting, cohort growth simulations, and resource quotas.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowCapacityForecastIndexManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_capacityforecastindex"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowCapacityForecastIndex")
        verbose_name_plural = _("AttendanceLeaveWorkflowCapacityForecastIndexs")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_dffe45d3_cd"),
            models.Index(fields=["created_at"], name="attend_attend_dffe45d3_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_dffe45d3_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_dffe45d3_dp"),
        ]
...
class AttendanceLeaveWorkflowSecurityCredentialLedgerQuerySet(models.QuerySet):
    """Custom QuerySet methods for AttendanceLeaveWorkflowSecurityCredentialLedger."""
    def active(self):
        return self.filter(is_active=True)
    def recent(self, days: int = 30):
        cutoff = timezone.now() - timezone.timedelta(days=days)
...
class AttendanceLeaveWorkflowSecurityCredentialLedgerManager(models.Manager):
    """Custom model manager for AttendanceLeaveWorkflowSecurityCredentialLedger."""
    def get_queryset(self):
        return AttendanceLeaveWorkflowSecurityCredentialLedgerQuerySet(self.model, using=self._db)
    def active(self):
        return self.get_queryset().active()
    def search(self, query: str):
        return self.get_queryset().search(query)
...
class AttendanceLeaveWorkflowSecurityCredentialLedger(models.Model):
    """
    AttendanceLeaveWorkflowSecurityCredentialLedger: Cryptographic key rotation, API access tokens, and security credential records.
    Enterprise Grade Institutional Entity with strict audit trails and SQLite optimization.
    """
    code = models.CharField(max_length=64, unique=True, db_index=True, verbose_name=_("Entity Code"))
    name = models.CharField(max_length=255, db_index=True, verbose_name=_("Entity Name"))
    ...
    objects = AttendanceLeaveWorkflowSecurityCredentialLedgerManager()

    class Meta:
        db_table = "attendance_attendance_leave_workflow_securitycredentialledger"
        ordering = ["-created_at", "code"]
        verbose_name = _("AttendanceLeaveWorkflowSecurityCredentialLedger")
        verbose_name_plural = _("AttendanceLeaveWorkflowSecurityCredentialLedgers")
        indexes = [
            models.Index(fields=["code", "status"], name="attend_attend_8434c1e8_cd"),
            models.Index(fields=["created_at"], name="attend_attend_8434c1e8_cr"),
            models.Index(fields=["priority", "status"], name="attend_attend_8434c1e8_pr"),
            models.Index(fields=["department_tag", "status"], name="attend_attend_8434c1e8_dp"),
        ]
