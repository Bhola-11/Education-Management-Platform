"""
Enterprise Forms for Attendance: Attendance Reporting
PR #41: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from attendance.models_attendance_reports import AttendanceReportsMaster, AttendanceReportsConfiguration, AttendanceReportsLedger

class AttendanceReportsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendanceReportsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ATTENDANCE_REPORTS-001"}),
...
class AttendanceReportsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AttendanceReportsConfiguration
...
class AttendanceReportsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AttendanceReportsLedger
...
class AttendanceReportsBatchActionForm(forms.Form):
...
class AttendanceReportsSearchFilterForm(forms.Form):
