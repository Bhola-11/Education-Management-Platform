"""
Enterprise Forms for Attendance: Staff Timekeeping
PR #38: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from attendance.models_attendance_staff import AttendanceStaffMaster, AttendanceStaffConfiguration, AttendanceStaffLedger

class AttendanceStaffMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendanceStaffMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ATTENDANCE_STAFF-001"}),
...
class AttendanceStaffConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AttendanceStaffConfiguration
...
class AttendanceStaffLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AttendanceStaffLedger
...
class AttendanceStaffBatchActionForm(forms.Form):
...
class AttendanceStaffSearchFilterForm(forms.Form):
