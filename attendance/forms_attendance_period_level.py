"""
Enterprise Forms for Attendance: Period Attendance
PR #37: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from attendance.models_attendance_period_level import AttendancePeriodLevelMaster, AttendancePeriodLevelConfiguration, AttendancePeriodLevelLedger

class AttendancePeriodLevelMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendancePeriodLevelMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ATTENDANCE_PERIOD_LEVEL-001"}),
...
class AttendancePeriodLevelConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AttendancePeriodLevelConfiguration
...
class AttendancePeriodLevelLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AttendancePeriodLevelLedger
...
class AttendancePeriodLevelBatchActionForm(forms.Form):
...
class AttendancePeriodLevelSearchFilterForm(forms.Form):
