"""
Enterprise Forms for Attendance: Leave Workflow
PR #39: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from attendance.models_attendance_leave_workflow import AttendanceLeaveWorkflowMaster, AttendanceLeaveWorkflowConfiguration, AttendanceLeaveWorkflowLedger

class AttendanceLeaveWorkflowMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendanceLeaveWorkflowMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ATTENDANCE_LEAVE_WORKFLOW-001"}),
...
class AttendanceLeaveWorkflowConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AttendanceLeaveWorkflowConfiguration
...
class AttendanceLeaveWorkflowLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AttendanceLeaveWorkflowLedger
...
class AttendanceLeaveWorkflowBatchActionForm(forms.Form):
...
class AttendanceLeaveWorkflowSearchFilterForm(forms.Form):
