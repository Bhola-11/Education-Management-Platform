"""
Enterprise Forms for Attendance: Attendance & Exams Tests
PR #98: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from attendance.models_attendance_and_exams_suite import AttendanceAndExamsSuiteMaster, AttendanceAndExamsSuiteConfiguration, AttendanceAndExamsSuiteLedger

class AttendanceAndExamsSuiteMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendanceAndExamsSuiteMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ATTENDANCE_AND_EXAMS_SUITE-001"}),
...
class AttendanceAndExamsSuiteConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AttendanceAndExamsSuiteConfiguration
...
class AttendanceAndExamsSuiteLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AttendanceAndExamsSuiteLedger
...
class AttendanceAndExamsSuiteBatchActionForm(forms.Form):
...
class AttendanceAndExamsSuiteSearchFilterForm(forms.Form):
