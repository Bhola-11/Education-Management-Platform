"""
Enterprise Forms for Attendance: Attendance Threshold Alerts
PR #40: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from attendance.models_attendance_alerts import AttendanceAlertsMaster, AttendanceAlertsConfiguration, AttendanceAlertsLedger

class AttendanceAlertsMasterForm(forms.ModelForm):
    """Primary form for creating and updating AttendanceAlertsMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. ATTENDANCE_ALERTS-001"}),
...
class AttendanceAlertsConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = AttendanceAlertsConfiguration
...
class AttendanceAlertsLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = AttendanceAlertsLedger
...
class AttendanceAlertsBatchActionForm(forms.Form):
...
class AttendanceAlertsSearchFilterForm(forms.Form):
