"""
Enterprise Forms for Dashboards: Faculty Workplace Hub
PR #82: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_teacher import DashboardsTeacherMaster, DashboardsTeacherConfiguration, DashboardsTeacherLedger

class DashboardsTeacherMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsTeacherMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_TEACHER-001"}),
...
class DashboardsTeacherConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsTeacherConfiguration
...
class DashboardsTeacherLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsTeacherLedger
...
class DashboardsTeacherBatchActionForm(forms.Form):
...
class DashboardsTeacherSearchFilterForm(forms.Form):
