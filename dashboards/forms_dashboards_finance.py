"""
Enterprise Forms for Dashboards: Bursar Financial Hub
PR #85: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_finance import DashboardsFinanceMaster, DashboardsFinanceConfiguration, DashboardsFinanceLedger

class DashboardsFinanceMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsFinanceMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_FINANCE-001"}),
...
class DashboardsFinanceConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsFinanceConfiguration
...
class DashboardsFinanceLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsFinanceLedger
...
class DashboardsFinanceBatchActionForm(forms.Form):
...
class DashboardsFinanceSearchFilterForm(forms.Form):
