"""
Enterprise Forms for Dashboards: Librarian Ops Hub
PR #86: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_librarian import DashboardsLibrarianMaster, DashboardsLibrarianConfiguration, DashboardsLibrarianLedger

class DashboardsLibrarianMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsLibrarianMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_LIBRARIAN-001"}),
...
class DashboardsLibrarianConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsLibrarianConfiguration
...
class DashboardsLibrarianLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsLibrarianLedger
...
class DashboardsLibrarianBatchActionForm(forms.Form):
...
class DashboardsLibrarianSearchFilterForm(forms.Form):
