"""
Enterprise Forms for Dashboards: Student Self-Service Hub
PR #83: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_student import DashboardsStudentMaster, DashboardsStudentConfiguration, DashboardsStudentLedger

class DashboardsStudentMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsStudentMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_STUDENT-001"}),
...
class DashboardsStudentConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsStudentConfiguration
...
class DashboardsStudentLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsStudentLedger
...
class DashboardsStudentBatchActionForm(forms.Form):
...
class DashboardsStudentSearchFilterForm(forms.Form):
