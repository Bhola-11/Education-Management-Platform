"""
Enterprise Forms for Dashboards: Dean Academic Dashboard
PR #81: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_principal import DashboardsPrincipalMaster, DashboardsPrincipalConfiguration, DashboardsPrincipalLedger

class DashboardsPrincipalMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsPrincipalMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_PRINCIPAL-001"}),
...
class DashboardsPrincipalConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsPrincipalConfiguration
...
class DashboardsPrincipalLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsPrincipalLedger
...
class DashboardsPrincipalBatchActionForm(forms.Form):
...
class DashboardsPrincipalSearchFilterForm(forms.Form):
