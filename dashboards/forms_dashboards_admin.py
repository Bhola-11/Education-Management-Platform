"""
Enterprise Forms for Dashboards: Executive Dashboard
PR #80: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_admin import DashboardsAdminMaster, DashboardsAdminConfiguration, DashboardsAdminLedger

class DashboardsAdminMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsAdminMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_ADMIN-001"}),
...
class DashboardsAdminConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsAdminConfiguration
...
class DashboardsAdminLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsAdminLedger
...
class DashboardsAdminBatchActionForm(forms.Form):
...
class DashboardsAdminSearchFilterForm(forms.Form):
