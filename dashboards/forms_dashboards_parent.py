"""
Enterprise Forms for Dashboards: Parent Family Portal
PR #84: Validation Hooks, Clean Methods, Accessible Layouts.
"""

from django import forms
from django.core.exceptions import ValidationError
from dashboards.models_dashboards_parent import DashboardsParentMaster, DashboardsParentConfiguration, DashboardsParentLedger

class DashboardsParentMasterForm(forms.ModelForm):
    """Primary form for creating and updating DashboardsParentMaster records."""
    class Meta:
        ...
        widgets = {
            "code": forms.TextInput(attrs={"class": "form-control", "placeholder": "e.g. DASHBOARDS_PARENT-001"}),
...
class DashboardsParentConfigurationForm(forms.ModelForm):
    """Configuration form for setting policy limits and weights."""
    class Meta:
        model = DashboardsParentConfiguration
...
class DashboardsParentLedgerEntryForm(forms.ModelForm):
    """Form for posting quantitative or financial transactions."""
    class Meta:
        model = DashboardsParentLedger
...
class DashboardsParentBatchActionForm(forms.Form):
...
class DashboardsParentSearchFilterForm(forms.Form):
